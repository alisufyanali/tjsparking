    ...
    <div class="nav-list">
        <div class="pcoded-inner-navbar main-menu">
            ...
            <ul class="pcoded-item pcoded-left-item">
                ...
                <li class="{{ Request::routeIs('admin.long_truck_parkings.index') ? 'active' : '' }}">
                    <a href="{{ route('admin.long_truck_parkings.index') }}" class="waves-effect waves-dark">
                        <span class="pcoded-micon">
                            <i class="fa fa-clock-o"></i>
                        </span>
                        <span class="pcoded-mtext">Long Term Parking</span>
                    </a>
                </li>
