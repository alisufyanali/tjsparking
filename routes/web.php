...
use App\Http\Controllers\Admin\LongTruckParkingController;
...
Route::group(['middleware' => ['auth', 'admin']], function () {
    ...
    Route::controller(AdminEmailController::class)->group(function () {
        ...
        Route::get('/admin/email/show/{id}', 'show')->name('admin.email.show'); 
    ...
    Route::controller(LongTruckParkingController::class)->group(function () {
        Route::get('/admin/long-truck-parking/index', 'index')->name('admin.long_truck_parkings.index'); 
        Route::post('/admin/long-truck-parking/store', 'store')->name('admin.long_truck_parkings.store');
        Route::get('/admin/long-truck-parking/create', 'create')->name('admin.long_truck_parkings.create'); 
        Route::get('/admin/long-truck-parking/edit/{id}', 'edit')->name('admin.long_truck_parkings.edit'); 
        Route::put('/admin/long-truck-parking/update/{id}', 'update')->name('admin.long_truck_parkings.update'); 
        Route::delete('/admin/long-truck-parking/destroy/{id}', 'destroy')->name('admin.long_truck_parkings.destroy'); 
    });
